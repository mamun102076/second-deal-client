...
const Footer = () => {
    return (
        <div>
            <footer className="footer footer-center p-10 text-primary-content bg-gradient-to-r from-teal-600 to-teal-800">
                <div>
                    <p className="font-bold text-xl">
                        Second Deal.com <br />is a reliable lapotop selling platform since 2019
                    </p>
                </div>
                <div>
